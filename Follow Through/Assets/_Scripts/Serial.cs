...
public class Serial : MonoBehaviour
{
	...
	void OnEnable ()
	{
		...
		checkOpen ( PortSpeed ); // TODO changed this from 9600
	...
	public static bool checkOpen (int speed = 115200) // TODO changed this from 9600
	{
		...
		if (s_serial == null) {
			...
			s_serial = new SerialPort (portName, speed);
			//s_serial = new SerialPort (portName, 115200);  // TODO changed this line from the one above
...
//		}
	...
	public float GetLasDataIn() {
		return s_lastDataIn;
	}

	public float GetLasDataCheck() {
		return s_lastDataCheck;
	}
